...
import (
	...
	"k8s.io/autoscaler/cluster-autoscaler/expander/highestprioritylabel"
...
func ExpanderStrategyFromString(expanderFlag string, cloudProvider cloudprovider.CloudProvider,
	...
	case expander.HighestPriorityLabelBasedExpanderName:
		return highestprioritylabel.NewStrategy(), nil
	}
