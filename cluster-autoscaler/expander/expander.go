...
var (
	...
	AvailableExpanders = []string{RandomExpanderName, MostPodsExpanderName, LeastWasteExpanderName, PriceBasedExpanderName, PriorityBasedExpanderName, HighestPriorityLabelBasedExpanderName}
	...
	// HighestPriorityLabelBasedExpanderName selects a node group based on a label configured in the cloud provider
	HighestPriorityLabelBasedExpanderName = "highestprioritylabel"
)
